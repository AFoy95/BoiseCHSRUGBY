...
<html>
   ...
   <body>
      <div id="header">
         ...
         <div class="topnav">
            <a class="active" href="/php/top-level/main_page.php" id = "1" >Main-page</a>
            <a href="/php/top-level/About_Us.php" id="2" >About-Us</a>
            <a href="/php/top-level/Personal_Bios.php" id ="3" >Personal-Bios</a>	
            <a href="/php/top-level/Schedules.php" id = "4" >Schedule</a>	
            <a href="/php/top-level/Tables.php" id = "5" >Tables</a>
            <a href="/php/login_handles/login.php" id = "6" >Admin Login</a>
